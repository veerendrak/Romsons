...
export class EnvConfigurationService {
    ...
    getRequiredApi(apiKey: string) {
        let apiUrls: any = {
            ...
            "get_vendor_ledger": "/report/vendor/ledger",
            "hsn_summary_report": "/report/hsn",
            "mcta_salesgroup_report": "/report/mcta/sgrps",
            "get_sales_group_persons": "/report/sales/persons",
            "get_gstr2_details": "/report/gstr2",
            "get_outgoing_payment_list": "/purchase/payment",
            "post_outgoing_payment": "/purchase/payment",
            "get_nil_summary_report": "/report/nill",
            "get_active_user_details": "/user/online",
            "get_intransit_details": "/purchase/intransits",
            "outgoing_payment_cancel": "/purchase/cancel",
            "sales_order_report": "/report/sales/orders",
            "target_achievement_report": "/report/target/achievement",
