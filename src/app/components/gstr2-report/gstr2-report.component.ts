    ...
    exportExcel() {
        ...
        if (this.gstrdetailsList.length != 0) {
            for (let index of this.gstrdetailsList) {
                ...
                if (!index.hasOwnProperty('inv_doc_num')) {
                    index.inv_doc_num = " ";
                }
            ...
            let columns: any = ['inv_id', 'inv_date', 'inv_doc_num', 'suppl_name', 'pos', 'rate', 'tax_val', 'sgst', 'cgst', 'igst', 'inv_value']
            let columnHeaders: any = ['Vendor Invoice No', 'Invoice Date', 'Invoice No', 'Supply Name', 'Place Of Supply', 'Rate', 'Taxable Value', 'S/UGST', 'CGST', 'IGST', 'Invoice Value']
